...
function SessionCard({
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-2xl border border-input bg-card px-5 py-4">
    ...
    <section className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 px-6 py-12">
      <div className="flex flex-col gap-1">
        ...
        {sessions && sessions.length > 0 && (
          <p className="text-base text-xl mt-4">
      ...
      >
        <DialogContent className="gap-6 p-8 sm:max-w-2xl">
          <DialogHeader className="gap-3">
            <DialogTitle className="text-2xl">¿Estás seguro/a?</DialogTitle>
            <DialogDescription className="text-base leading-relaxed mt-2">
              ...
              (exámenes, informes, rúbricas etc.) del sistema. Esta acción no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
