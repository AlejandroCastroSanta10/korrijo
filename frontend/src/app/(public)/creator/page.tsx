    ...
    <div className="mx-auto max-w-3xl px-6 py-16 flex flex-col gap-16">
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <a
            href="https://www.linkedin.com/in/alejandro-castro-santa-284498345/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors w-fit"
          >
            <LinkedinIcon />
            LinkedIn
          </a>
          <a
            href="https://github.com/AlejandroCastroSanta10"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors w-fit"
          >
