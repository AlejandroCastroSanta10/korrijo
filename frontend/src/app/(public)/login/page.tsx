...
const steps = [
  {
    ...
    description: (
      <>
        Al crear una sesión de corrección debes subir:
        <ol className="mt-2 list-decimal list-inside space-y-1">
          <li>Documentos con contexto, por ejemplo apuntes (opcional)</li>
          <li>Examen resuelto a modo de modelo (obligatorio)</li>
          <li>Rúbrica de corrección (obligatorio)</li>
        </ol>
      </>
    ),
  },
  {
    ...
    number: 2,
    description:
      "Posteriormente ya podrás adjuntar los exámenes que quieras que se corrijan",
  },
  {
    icon: Check,
    number: 3,
    description:
      "Para cada examen Korrijo proporciona un informe con feedback sobre la corrección y la rúbrica rellenada con una calificación propuesta",
  },
];
        ...
        <div className="mx-auto max-w-5xl flex flex-col gap-12">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-2xl text-zinc-600 dark:text-zinc-400">
              <i>Korrijo</i> es un sistema para profesores que facilita la corrección
              de pruebas evaluativas manuscritas gracias a herramientas de IA.
            </p>
          </div>
