...
def pdf_to_images(pdf_path: str | Path, dpi: int = 300) -> list[bytes]:
    ...
    Parámetros:
        ...
        dpi: resolución de renderizado. 300 da buena legibilidad del
            manuscrito (nombres propios, cifras) sin disparar en exceso el
            tamaño de la imagen ni los tokens que consume el VLM.
